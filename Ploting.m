...
for i = 1:height(nameddata)
    ...
    YuupoPlot_fun(datafolder,Name(1),1,2,DataPos,UpperLimit,LowerLimit,filter,true) %YuupoPlot_fun(location,fileName,X,Y,TargetStrengh,ColorBarLimitUpper,ColorBarLimitLower,filter,Plot2D)
end